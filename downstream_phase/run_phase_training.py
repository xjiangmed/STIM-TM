...
sys.path.append("/home/xjiangbh/VideoTokenpruning_work/STIM-TM/")
...
from model.surgformer_HTA_ToMe import surgformer_HTA_ToMe 
...
def get_args():
    ...
    # ToMe
    parser.add_argument("--enable_ToMe", action="store_true", default=False)
    parser.add_argument('--config', default='./configs/Testa_ToMe.yaml')
...
def main(args, ds_init):
    ...
    # print('args.batch_size:', args.batch_size) #8
    ...
    if dataset_val is not None:
        data_loader_val = torch.utils.data.DataLoader(
            ...
            batch_size=int(5 * args.batch_size),
            num_workers=args.num_workers,
            pin_memory=args.pin_mem,
            drop_last=False,
        )
    ...
    if args.eval:
        ...
        if global_rank == 0:
            print("Start merging results...") #0.txt 偶数帧； 1.txt 奇数帧 两卡测试
    ...
    best_pretrained_path = os.path.join(args.output_dir, "checkpoint-best.pth")
